...
public class CouponIssueRedisCache {
    ...
    public Long getIssuedCouponUserCount(String key) {
        try {
            ...
            throw new CommonException("Failed to Get Issued Coupon User Count", COMMON_SYSTEM_ERROR);
        }
    }
    ...
    public Long addIssuedCouponUser(String key, String value) {
        try {
            ...
            throw new CommonException("Failed to Add Issued Coupon User", COMMON_SYSTEM_ERROR);
        }
    }
}
